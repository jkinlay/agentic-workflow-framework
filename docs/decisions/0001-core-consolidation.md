...
Historical decision for the first core candidate. The [follow-up decision](0002-review-and-evidence.md) supersedes its adapter-removal and global documentation-budget choices for the current release.
