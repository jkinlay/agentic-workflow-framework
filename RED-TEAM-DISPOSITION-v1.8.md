...
| Behavioral evidence | Accept the limited mechanism: a self-reported structured-decision smoke harness with exact packet/prompt bindings. It runs no model and its public rubric can be copied into observations. It does not measure prompt quality, host actions or model-quality equivalence. |
