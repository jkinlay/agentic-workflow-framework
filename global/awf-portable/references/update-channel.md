...
Run `scripts/check_updates.py --project ABSOLUTE_PROJECT --channel CHANNEL_LOCATION`. Add `--version 1.9` for a family or `--version 1.9.2` for an exact release. Missing/unavailable metadata does not establish latest.
